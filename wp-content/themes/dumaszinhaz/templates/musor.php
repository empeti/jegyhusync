...
<?php // megvan a műsor, rakjuk ki?>
    <div id="musor">
        ...
        <p class="jegy-hu-link">
            <a href="http://dumaszinhaz.jegy.hu/arrivalorder.php?eid=<?php echo $musor->jegy_hu_id?>&template=201311_vasarlas" target="_blank">jegyvásárlás</a>
        </p>
    </div>
